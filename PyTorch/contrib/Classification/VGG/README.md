...
### 2.2 准备数据集
#### 2.2.1 获取数据集
VGG使用 ImageNet 数据集，该数据集为开源数据集，可从 [ImageNet](https://image-net.org/) 下载。
...
1. 在构建好的环境中，进入训练脚本所在目录。
    ```
    cd <ModelZoo_path>/PyTorch/contrib/Classification/vgg/mmpretrain/run_scripts
    ```
...
![vgg_loss_compare](./images/loss.jpg)

MeanRelativeError: 1.735959588932631e-05
MeanAbsoluteError: 4.212691114004886e-05
Rule,mean_relative_error 1.735959588932631e-05
pass mean_relative_error=1.735959588932631e-05 <= 0.05 or mean_absolute_error=4.212691114004886e-05 <= 0.0002