...
### 2.2 准备数据集
#### 2.2.1 获取数据集
repvgg使用 ImageNet 数据集，该数据集为开源数据集，可从 [ImageNet](https://image-net.org/) 下载。
...
MeanRelativeError: 0.0016624496387565258
MeanAbsoluteError: 0.011293330995163114
Rule,mean_relative_error 0.0016624496387565258
pass mean_relative_error=0.0016624496387565258 <= 0.05 or mean_absolute_error=0.011293330995163114 <= 0.0002