...
2. 运行训练。该模型支持单机单卡。
    ```
   torchrun --master_port=29500 ./run_resnext.py ./SE-ResNet/seresnet50_8xb32_in1k.py --launcher pytorch --amp | tee sdaa.log
   ```
...
![vgg_loss_compare](./image/seresnet_loss_compare.jpg)

MeanRelativeError: 0.0026197421825202446
MeanAbsoluteError: 0.019373114746395904
Rule,mean_relative_error 0.0026197421825202446
pass mean_relative_error=0.0026197421825202446 <= 0.05 or mean_absolute_error=0.019373114746395904 <= 0.0002