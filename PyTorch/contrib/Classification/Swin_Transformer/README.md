...
### 2.2 准备数据集
#### 2.2.1 获取数据集
Swin Transformer使用 ImageNet 数据集，该数据集为开源数据集，可从 [ImageNet](https://image-net.org/) 下载。
...
MeanRelativeError: -0.0016713390677915647
MeanAbsoluteError: -0.01210863755481078
Rule,mean_absolute_error -0.01210863755481078
pass mean_relative_error=-0.0016713390677915647 <= 0.05 or mean_absolute_error=-0.01210863755481078 <= 0.0002