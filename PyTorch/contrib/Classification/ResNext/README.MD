...
2. 运行训练。该模型支持单机单卡。
    ```
   torchrun --master_port=29500 ./run_resnext.py ./ResNext/resnext50-32x4d_8xb32_in1k.py --launcher pytorch --amp | tee sdaa.log
   ```
...
![vgg_loss_compare](./image/resnext_loss_compare.jpg)
