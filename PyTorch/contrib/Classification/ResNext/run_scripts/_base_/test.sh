...
# 训练参数配置
config_file="$script_path/ResNext/resnext50-32x4d_8xb32_in1k.py"
log_file="$script_path/work_dirs/resnext50-32x4d_8xb32_in1k/logs/sdaa.log"
cuda_log_file="$script_path/cuda.log"
train_file="$script_path/run_resnext.py"
