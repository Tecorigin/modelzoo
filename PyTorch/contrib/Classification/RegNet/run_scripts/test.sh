...
# 训练参数配置
config_file="$script_path/RegNet/regnetx-400mf_8xb128_in1k.py"
log_file="$script_path/work_dirs/regnetx-400mf_8xb128_in1k/logs/sdaa.log"
cuda_log_file="$script_path/cuda.log"
train_file="$script_path/run_regnet.py"
