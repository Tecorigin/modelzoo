...
### 2.2 准备数据集
#### 2.2.1 获取数据集
ShuffleNet v2使用 ImageNet 数据集，该数据集为开源数据集，可从 [ImageNet](https://image-net.org/) 下载。
...
MeanRelativeError: -0.0014035271144460257
MeanAbsoluteError: -0.010106818510754274
Rule,mean_absolute_error -0.010106818510754274
pass mean_relative_error=-0.0014035271144460257 <= 0.05 or mean_absolute_error=-0.010106818510754274 <= 0.0002