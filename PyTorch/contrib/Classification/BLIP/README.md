# BLIP
## 1. 模型概述
BLIP（Bootstrapping Language-Image Pre-training）是一个统一的视觉-语言预训练模型，能够同时理解图像内容并生成自然语言描述，支持多种任务如图像-文本检索、图像描述、视觉问答等。
...
MeanRelativeError: -0.007578191046012271
MeanAbsoluteError: -0.06411135078656792
Rule,mean_absolute_error -0.06411135078656792
pass mean_relative_error=-0.007578191046012271 <= 0.05 or mean_absolute_error=-0.06411135078656792 <= 0.0002
