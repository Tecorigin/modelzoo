...
### 2.2 准备数据集
#### 2.2.1 获取数据集
ShuffleNet v1使用 ImageNet 数据集，该数据集为开源数据集，可从 [ImageNet](https://image-net.org/) 下载。
...
MeanRelativeError: -0.06525006341007093
MeanAbsoluteError: -0.8240810432056389
Rule,mean_absolute_error -0.8240810432056389
pass mean_relative_error=-0.06525006341007093 <= 0.05 or mean_absolute_error=-0.8240810432056389 <= 0.0002