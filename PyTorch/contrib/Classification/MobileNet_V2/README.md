...
2. 运行训练。该模型支持单机单卡。
    ```
   torchrun --master_port=29500 ./run_mobilenet_v2.py ./mobilenet-v2/mobilenet-v2_8xb32_in1k.py --launcher pytorch --amp | tee sdaa.log
   ```
...
Rule,mean_absolute_error -0.046302809573636194
pass mean_relative_error=-0.006017453958086077 <= 0.05 or mean_absolute_error=-0.046302809573636194 <= 0.0002