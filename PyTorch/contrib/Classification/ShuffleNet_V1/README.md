...
2. 运行训练。该模型支持单机单卡。
    ```
   torchrun --master_port=29500 ./run_resnext.py ./shufflenet_v1/shufflenet-v1-1x_16xb64_in1k.py --launcher pytorch --amp | tee sdaa.log
   ```
...
![vgg_loss_compare](./image/shufflenet_v1_loss_compare.jpg)
