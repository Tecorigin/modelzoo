        ...
        for lr in lrs:
            ...
            for epoch in range(int(args.num_train_epochs)):
                ...
                for step, batch in enumerate(train_batches):
                    ...
                    input_ids = input_ids.to('sdaa')
                    input_mask = input_mask.to('sdaa')
                    segment_ids = segment_ids.to('sdaa')
                    start_positions = start_positions.to('sdaa')
                    end_positions = end_positions.to('sdaa')
                    ...
                    logger.info('Epoch: {}, Step: {} / {}, current_loss = {:.6f}'.format(
                        epoch, step + 1, len(train_batches), loss.item()))                    
