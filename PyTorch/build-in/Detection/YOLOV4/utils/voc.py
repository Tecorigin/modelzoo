...
if __name__ == "__main__":
    ...
    train_annotation_path = "/data/application/huangyun/YOLOv4-pytorch-master/data/train_annotation.txt"
    ...
    test_annotation_path = "/data/application/huangyun/YOLOv4-pytorch-master/data/test_annotation.txt"
