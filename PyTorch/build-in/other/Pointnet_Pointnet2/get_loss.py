...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/localnvme/application/huangyun/Pointnet_Pointnet2_pytorch-master/sdaa.txt")
    parser.add_argument('--cuda-log', type=str,default="/localnvme/application/huangyun/Pointnet_Pointnet2_pytorch-master/log/classification/pointnet2_cls_ssg/logs/pointnet2_cls_ssg.txt")
