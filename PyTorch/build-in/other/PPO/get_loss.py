...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/localnvme/application/huangyun/PPO/sdaa.log")
    parser.add_argument('--cuda-log', type=str,default="/localnvme/application/huangyun/PPO/cuda.log")
