...
# 保存处理后的数据
processed_path = nyc_taxi_raw_path.parent.parent.joinpath('labeled')
processed_path.mkdir(parents=True, exist_ok=True)

# 保存完整数据集
full_dataset_path = processed_path.joinpath('nyc_taxi.pkl')
with open(str(full_dataset_path), 'wb') as pkl:
    pickle.dump(labeled_data, pkl)

# 分别保存训练集和测试集
train_path = processed_path.joinpath('nyc_taxi_train.pkl')
test_path = processed_path.joinpath('nyc_taxi_test.pkl')
