...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/localnvme/application/huangyun/iTransformer/sdaa.log")
    parser.add_argument('--cuda-log', type=str,default="/localnvme/application/huangyun/iTransformer/cuda.log")
