...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/localnvme/application/huangyun/BETR_mutimodal_transformers/sdaa_step_losses_mosi_bert-base-uncased.txt")
    parser.add_argument('--cuda-log', type=str,default="/localnvme/application/huangyun/BETR_mutimodal_transformers/step_losses_mosi_bert-base-uncased.txt")
