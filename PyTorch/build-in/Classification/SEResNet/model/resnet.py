...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           ...
           'wide_resnet50_2', 'wide_resnet101_2', 'model_urls']
    ...
    def load_from_resnet(self, state_dict):
        ...
        for module_name, module in self.named_modules():
            if isinstance(module, nn.Conv2d) or isinstance(module, nn.BatchNorm2d):
                if module_name + '.weight' not in state_dict:
                    print(f'Module not exist in the state_dict: {module_name}')
                elif isinstance(module, nn.Conv2d):
                    weight_name = module_name + '.weight'
                    module.weight.data.copy_(state_dict[weight_name])
                    loaded_param_names.append(weight_name)
        ...
        remaining_names = set(state_dict.keys()) - set(loaded_param_names)
        if remaining_names:
