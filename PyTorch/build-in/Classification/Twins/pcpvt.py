...
# welo: minimal Twins/CPVT/ALTGVT factory — no pretrained, CIFAR-friendly
def Model(num_classes=100, model_type='pcpvt_small_v0'):
    model_map = {
        'pcpvt_small_v0': pcpvt_small_v0,
        'pcpvt_base_v0': pcpvt_base_v0,
        'pcpvt_large_v0': pcpvt_large_v0,
        'alt_gvt_small': alt_gvt_small,
        'alt_gvt_base': alt_gvt_base,
        'alt_gvt_large': alt_gvt_large,
    }

    if model_type not in model_map:
        raise ValueError(f"Unknown model_type: {model_type}")

    # minimal: no pretrained, no extra args
    return model_map[model_type](pretrained=False, num_classes=num_classes)