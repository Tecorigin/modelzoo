...
class LinearBottleneck(nn.Module):
    def __init__(self, in_channels, channels, t, stride, use_se=True, se_ratio=12,
        ...
        ConvBNAct(out, in_channels=dw_channels, channels=channels, active=False, relu6=False)
...
class ReXNetV1(nn.Module):
    def __init__(self, input_ch=16, final_ch=180, width_mult=0.7, depth_mult=1.0, classes=100,
                 use_se=True,
                 se_ratio=12,
                 dropout_ratio=0.2,
                 bn_momentum=0.9):
...
def Model(classes_n):
    ...
    """
    return ReXNetV1(classes = classes_n)